...
namespace AlexaNetCore.Model
{
    ...
    public class AlexaSlotValidationIsLessThanOrEqualTo<T> : IAlexaSlotValidation
    {
        ...
        /// <summary>
        /// Forces slot value to be smaller than or equal to the given value. If the value check fails,
        ...
        /// <param name="item">largest valid value of the given type</param>
        /// <param name="str">Prompt to use when asking the user for another value </param>
        public AlexaSlotValidationIsLessThanOrEqualTo(T item, string str)
        {
        ...
        /// <param name="item">largest valid value of the given type</param>
        /// <param name="str">Prompt to use when asking the user for another value </param>
        public AlexaSlotValidationIsLessThanOrEqualTo(T item, AlexaMultiLanguageText prompt)
        {
        ...
        public AlexaSlotValidationIsLessThanOrEqualTo<T> AddInvalidValuePromptVariation(string promptTxt)
        {
