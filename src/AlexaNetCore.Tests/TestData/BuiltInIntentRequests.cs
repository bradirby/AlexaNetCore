...
{
    public class BuiltInIntentRequests 
    {
        ...
        public static string LaunchRequest=> $"{StartOfRequest()}{AlexaBuiltInIntents.NoIntent}{EndOfRequest()}".Replace("IntentRequest","LaunchRequest");
